...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::get('/recent-post', [PostController::class, 'index2']);
...
Route::group(['middleware' => ['auth', 'role:admin']], function () {
    Route::get('/log',[SiteController::class, 'index']);
    Route::get('/log',[SiteController::class, 'logs'])->name('logs');
    Route::get('/shoes', [ShoesController::class, 'index']);
    Route::get('/edit/{shoes}', [ShoesController::class, 'edit']);
    Route::get('/delete/{shoes}', [ShoesController::class, 'destroy']);
